 ...
 * Description: This class is called and executed after the sixth question. It is the seventh question
 *
 */
public class SeventhQuestion extends JFrame implements ActionListener {
	...
	JButton answerA = new JButton("A - Kim Campbell");
	JButton answerB = new JButton("B - Christy Clark");
	JButton answerD = new JButton("D - Annamie Paul");
	JButton answerC = new JButton("C - Rita Johnson");
	 ...
	 *  Constructor 
	 */
	public SeventhQuestion() throws LineUnavailableException, IOException, UnsupportedAudioFileException {
		...
		ImageIcon question = new ImageIcon("questionSeven.png");
	...
	public void actionPerformed(ActionEvent e) {
		...
		else if (tries7 < 3 && e.getSource() != answerA) {
			tries7++;
			clip2.stop();
			this.dispose();
			clip3.start();
			JOptionPane.showMessageDialog(null, "Sorry you ran out of tries! \nTries: " + tries7 + "/3" + "\n Answer was: A - Kim Campbell", 
