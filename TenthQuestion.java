 ...
 * Description: This class is called and executed after the nineth question. It is the tenth question
 *
 */
public class TenthQuestion extends JFrame implements ActionListener {

	// Static variables to access them within different classes, set tries and score to zero initially
	static int tries10 = 0;
	...
	JButton answerA = new JButton("A - R. B. Bennett");
	JButton answerB = new JButton("B - Charles Tupper");
	JButton answerD = new JButton("D - John Diefenbaker");
	JButton answerC = new JButton("C - John Abbott");
	 ...
	 *  Constructor 
	 */
	public TenthQuestion() throws LineUnavailableException, IOException, UnsupportedAudioFileException {
		...
		ImageIcon question = new ImageIcon("questionTen.png");
