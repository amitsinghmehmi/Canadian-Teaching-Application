 ...
 * Description: Description: This class is called and executed after the fifth question. It is the sixth question
 *
 */
public class SixthQuestion extends JFrame implements ActionListener {
	...
	JButton answerA = new JButton("A - The Honourable");
	JButton answerB = new JButton("B - Prime Minister");
	JButton answerD = new JButton("D - The Right Honourable");
	JButton answerC = new JButton("C - The Righteous");
	 ...
	 *  Constructor 
	 */
	public SixthQuestion() throws LineUnavailableException, IOException, UnsupportedAudioFileException {
		...
		ImageIcon question = new ImageIcon("questionSix.png");
	...
	public void actionPerformed(ActionEvent e) {
		...
		else if (tries6 < 3 && e.getSource() != answerD) {
			tries6++;
			clip2.stop();
			this.dispose();
			clip3.start();
			JOptionPane.showMessageDialog(null, "Sorry you ran out of tries! \nTries: " + tries6 + "/3" + "\n Answer was: D - The Right Honourable", 
