 ...
 * Description: This class is called and executed after the tenth question. It is the eleventh question
 *
 */
public class EleventhQuestion extends JFrame implements ActionListener {
	
	// Static variables to access them within different classes, set tries and score to zero initially 
	static int tries11 = 0;
	...
	JButton answerA = new JButton("A - 16 points");
	JButton answerB = new JButton("B - 12 points");
	JButton answerD = new JButton("D - 9 Points");
	JButton answerC = new JButton("C - 11 Points");
	 ...
	 *  Constructor 
	 */
	public EleventhQuestion() throws LineUnavailableException, IOException, UnsupportedAudioFileException {
		...
		ImageIcon question = new ImageIcon("questionEleven.png");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == answerA) {
			answer11 = "A - 16 Points";
		}
		else if (e.getSource() == answerB) {
			answer11 = "B - 12 Points";
		}
		else if (e.getSource() == answerC) {
			answer11 = "C - 11 Points";
			score11++;			// Adding one to the score if it answered correctly
		}
		else {
			answer11 = "D - 9 Points";
		}
