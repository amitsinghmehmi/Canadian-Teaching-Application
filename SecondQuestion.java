 ...
 * Description: Description: This class is called and executed after the first question. It is the second question
 *
 */
public class SecondQuestion extends JFrame implements ActionListener {
	...
	JButton answerA = new JButton("A - Conservatives");
	JButton answerB = new JButton("B - Liberals");
	JButton answerD = new JButton("D - NDP");
	JButton answerC = new JButton("C - Green");
	 ...
	 *  Constructor 
	 */
	public SecondQuestion() throws LineUnavailableException, IOException, UnsupportedAudioFileException {
		...
		ImageIcon questionOne = new ImageIcon("questionTwo.png");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == answerA) {
			answer2 = "A - Conservatives";
			score2++;		// Adding one to the score if it answered correctly
		}
		...
		else if (tries2 < 3 && e.getSource() != answerA) {
			tries2++;
			clip2.stop();
			this.dispose();
			clip3.start();
			JOptionPane.showMessageDialog(null, "Sorry you ran out of tries! \nTries: " + tries2 + "/3" + "\n Answer was: A - Conservatives", 
